...
public class SQLiteGTSAttributeAdapter implements AttributeAdapter<GTSAttribute> {
    ...
    public static final String CREATE_SETTINGS_TABLE = SQLGTSAttributeAdapter.CREATE_SETTINGS_TABLE;
    ...
    public static final String UPDATE_OR_CREATE_SETTINGS = """
            ...
            VALUES (?, ?)
            ON CONFLICT(owner) DO UPDATE SET settings = excluded.settings;
            """;
